...
public class DeliveredFragment extends Fragment implements RefershLayout {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        binding.deliveredOrderList.setLayoutManager(new LinearLayoutManager(DeliveredFragment.this.getActivity(), RecyclerView.VERTICAL, false));
         adapter = new OrderAdapter(3, DeliveredFragment.this.myOrderList, DeliveredFragment.this.singleTask, DeliveredFragment.this.getActivity(), DeliveredFragment.this.fragmentManager);
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() { // from class: digi.coders.capsicodeliverypartner.fragment.DeliveredFragment.1.1
                    ...
                    public void run() {
                        ...
                        page = 0;
                        DeliveredFragment.this.loadDeliveredOrderList();
                        DeliveredFragment.this.binding.refresh.setRefreshing(false);
                    }
                }, 2000L);
            }
        });
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (res.equals("success")) {
                            DeliveredFragment.this.binding.progressBar.setVisibility(View.GONE);
...
//                            HomeFragment.countComplete.setVisibility(View.VISIBLE);
                            ...
                            DeliveredFragment.this.binding.deliveredOrderList.setAdapter(adapter);
                            DeliveredFragment.this.binding.noTxt.setVisibility(View.GONE);
                            return;
                        }else {
                            DeliveredFragment.this.binding.progressBar.setVisibility(View.GONE);
                            DeliveredFragment.this.binding.noTxt.setVisibility(View.VISIBLE);
                        }
